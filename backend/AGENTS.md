...
| **Connector** (`/api/connector`) | Proxy to AnyConnct runtime: `GET /v1/providers` - list SaaS providers; `GET /v1/apps` - list configured apps; `GET /v1/connections` - list active connections; `DELETE /v1/connections/{id}` - disconnect; `GET /v1/oauth/callback` - OAuth callback handler |
